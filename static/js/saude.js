let idSenhaAtual = null; // Variável global no topo do saude.js

// Quando você recebe o JSON do "chamar_proximo"
// idSenhaAtual = dadosDaResposta.id;

// E no seu objeto de dados para o POST:
const dados = {
    senha_id: idSenhaAtual, // Adicione isso aqui!
    especialidade: document.getElementById('cad-especialidade').value,
    // ... os outros campos que já estão lá
};
